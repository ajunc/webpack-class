...
class NormalModule extends Module {
	...
	doBuild(options, compilation, resolver, fs, callback) {
		...
		runLoaders(
			...
			(err, result) => {
				if (result) {
					this.buildInfo.cacheable = result.cacheable; // 模块路径
					this.buildInfo.fileDependencies = new Set(result.fileDependencies); // options中配置的loader
	...
	//被Compilation.js中的_buildModule方法中的module.build调用
